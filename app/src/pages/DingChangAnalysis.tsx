  ...
  const result: DingChangResult = {
    ...
    dimensions: {
      dividendQuality: {
        ...
        dividend_yield: getSubDim('dividendQuality', 'dividend_yield'),
        yield_5y_avg: getSubDim('dividendQuality', 'yield_5y_avg'),
        payout_consistency: getSubDim('dividendQuality', 'payout_consistency'),
        distribution_quality: getSubDim('dividendQuality', 'distribution_quality'),
        capital_return_efficiency: getSubDim('dividendQuality', 'capital_return_efficiency'),
      },
      valuationSafety: {
        score: getSubDim('valuationSafety', 'score'),
        pe_ttm: getSubDim('valuationSafety', 'pe_ttm'),
        pe_percentile: getSubDim('valuationSafety', 'pe_percentile'),
        pb: getSubDim('valuationSafety', 'pb'),
        pb_percentile: getSubDim('valuationSafety', 'pb_percentile'),
        peg: getSubDim('valuationSafety', 'peg'),
        spread_risk_free: getSubDim('valuationSafety', 'spread_risk_free'),
        nav_discount_premium: getSubDim('valuationSafety', 'nav_discount_premium'),
      },
      profitability: {
        score: getSubDim('profitability', 'score'),
        roe: getSubDim('profitability', 'roe'),
        roic: getSubDim('profitability', 'roic'),
        earnings_stability: getSubDim('profitability', 'earnings_stability'),
        earnings_growth_3y: getSubDim('profitability', 'earnings_growth_3y'),
        revenue_growth_3y: getSubDim('profitability', 'revenue_growth_3y'),
        cash_flow_quality: getSubDim('profitability', 'cash_flow_quality'),
      },
      capitalFlow: {
        score: getSubDim('capitalFlow', 'score'),
        aum: getSubDim('capitalFlow', 'aum'),
        aum_growth_3m: getSubDim('capitalFlow', 'aum_growth_3m'),
        aum_growth_1y: getSubDim('capitalFlow', 'aum_growth_1y'),
        volume_trend: getSubDim('capitalFlow', 'volume_trend'),
        institutional_ratio: getSubDim('capitalFlow', 'institutional_ratio'),
        institutional_change: getSubDim('capitalFlow', 'institutional_change'),
        fund_flow_20d: getSubDim('capitalFlow', 'fund_flow_20d'),
      },
      macroFit: {
        score: getSubDim('macroFit', 'score'),
        cycle_position: get('cycle_position') as string || '',
        cycle_fit_score: getSubDim('macroFit', 'cycle_fit_score'),
        rate_environment_fit: getSubDim('macroFit', 'rate_environment_fit'),
        policy_support: getSubDim('macroFit', 'policy_support'),
        global_comparison: getSubDim('macroFit', 'global_comparison'),
        macro_risk_score: getSubDim('macroFit', 'macro_risk_score'),
      },
    },
